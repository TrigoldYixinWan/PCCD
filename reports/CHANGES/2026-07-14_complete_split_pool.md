...
Date / commits: 2026-07-14 / `256d85b`, `3b13967`
...
to 6,300 and the pool description changes from approximately 10.7k to 10.8k. Each of the
...
Why this and not an alternative: Adding 100 PKU items closes the explicit arithmetic gap;
